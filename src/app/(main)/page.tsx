  ...
  return (
    <div className="bg-uq-content-bg p-3 border border-border rounded-none shadow-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
        ...
        <main className="md:col-span-2">
              ...
              images={[
                {
                  ...
                  title: "Welcome to Nairobi College",
                  description: "Discover your potential with us"
                },
                {
                  src: "/images/download.jpg",
                  alt: "Student Life",
                  title: "Student Community",
                  description: "Join our diverse community of learners"
                },
                {
                  src: "/images/download-1.jpg",
                  alt: "Academic Excellence",
                  title: "Academic Excellence",
                  description: "Build your future with Nairobi College"
                },
                {
                  src: "/images/images-1.jpg",
                  alt: "Campus Life",
                  title: "Campus Experience",
                  description: "Experience the vibrant Nairobi College community"
                }
              ]}
              autoPlay={true}
              interval={4000}
          ...
          {activeTab === 'notifications' && (
             <div className="py-3">
              ...
              <Card className="shadow-none border-border rounded-none mt-4">
        ...
        {/* Right Sidebar: Student Clubs */}
        <aside className="md:col-span-1 space-y-0">
          <SidebarModule title="Student Clubs" defaultOpen={true}>
            <SidebarLink href="/coding-club" icon={<Briefcase size={14}/>}>Coding Club</SidebarLink>
          </SidebarModule>
        </aside>
      </div>
    </div>
